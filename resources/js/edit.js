...
import {editFirstname,editEmail,editSubmit,editErrorName,editErrorEmail} from './vars.js';
import { PATTERNFIRSTNAME,PATTERNEMAIL } from './expressions.js';
const task = window.location.pathname.split('/');

if(editEmail!==null && editSubmit!==null && editErrorName!==null && editErrorEmail!==null){
